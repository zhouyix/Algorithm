...
class Solution {
    public int myAtoi(String str) {
        ...
        int sum = 0;
        while(begin < len && str.charAt(begin) >= '0' && str.charAt(begin) <='9'){
            int suffix = str.charAt(begin)-'0';
            if(!isNegative && (Integer.MAX_VALUE - suffix) / 10 < sum){
                return Integer.MAX_VALUE;
            }else if(isNegative && (Integer.MIN_VALUE+suffix)/10 > -1*sum){
